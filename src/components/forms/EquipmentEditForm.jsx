...
const EquipmentEditForm = Form.create()(
    (props) => {
                ...
                <Form layout='vertical'>
                    <FormItem label='设备名称'>
                        {getFieldDecorator('equipmentName', {
                            ...
                            initialValue: props.infos.equipmentName
                        })(
                            <Input />
                        )}
                    </FormItem>
                    <FormItem label='设备单价'>
                        {getFieldDecorator('equipmentPrice', {
                            ...
                            initialValue: props.infos.equipmentPrice
                        })(
                            <InputNumber
                    ...
                    <FormItem label='设备数量'>
                        {getFieldDecorator('equipmentNumber', {
                            ...
                            initialValue: props.infos.equipmentNumber
                        })(
                            <InputNumber min={0} />
                        )}
                    </FormItem>
                    <FormItem label='设备类型'>
                        {getFieldDecorator('equipmentType', {
                            ...
                            initialValue: props.infos.equipmentType.toString()
                        })(
                            <Select defaultValue={props.infos.equipmentType} style={{ width: 120 }}  >
                    ...
                    <FormItem label='设备图片'>
                        {getFieldDecorator('equipmentUrl', {
                            initialValue: props.infos.equipmentUrl
                        })(
                            <Input />
                        )}
                    </FormItem>
...
class EquipmentEdit extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            infos: {
                ...
                equipmentUrl: '',
                equipmentName: '',
                equipmentType: '',//（0 车床 ，1铣床， 2， 数控）
                equipmentTypeName: '',//（0 车床 ，1铣床， 2， 数控）
    ...
    handleCreate() {
        ...
        form.validateFields((err, values) => {
            ...
            var json = {};
            json = values;
            json.equipmentId = this.state.infos.equipmentId;
            axios.put(Base.inventoryAPI + '/inventory-equipment/update', json)
                .then(result => {
                    if (result.status === 200 && result.data.code === 200) {
                        this.props.getUser();
                    }
