...
const FinancialMaintainAddForm = Form.create()(
    (props) => {
...
class FinancialMaintainAdd extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            addVisible: false
    ...
    handleCreate() {
        ...
        form.validateFields((err, values) => {
            ...
            var json = {};
            json = values;
            axios.post(Base.financialAPI + '/financial-maintain/add', json)
                .then(result => {
                    if (result.status === 200 && result.data.code === 200) {
                        this.props.getUser();
                    }
...
export default FinancialMaintainAdd;